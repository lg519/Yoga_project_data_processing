...
# from amplifier_config import get_channel_config, sampling_frequency
...
# ):
#     # get channel names
#     channel_names = get_channel_config()
...
#         num_channels, 1, sharex=True, figsize=(10, 2 * num_channels)
#     )
